...
while(True):
        ...
        print('(f) Inserir no Final')#ok
        print('(b) Procurar um valor na lista') #ok
        print('(e) Consultar o conteúdo de um elemento')#ok
        print("(t) Trocar ordem dos elementos") #ok
        print('(v) Consultar se a lista está vazia') #ok
        print('(s) Obter tamanho da lista') #ok
        print('(r) Remover no início') #ok
        print('(o) Remover no Final') #ok
        print('(l) Remover todos os elementos da lista') #ok
        print('(p) Imprimir lista') #ok
        print('(m) mudar a lista') #ok
        print('(x) Sair do programa') #ok
        print('---------------------')
        try:
